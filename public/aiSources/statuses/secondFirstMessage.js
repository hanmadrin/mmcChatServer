        ...
        if (IOML && !hasSentVin) {
            ...
            if (HMCMS < 3) {
                ...
                if (AOM && OMWT > 3) {
                    ...
                    await sendNewFirstMessage(FIXED_DATA.allStatuses.thirdFirstMessage, chatHistory, showAiUpdates, actionConfirmation);
                } else if (!AOM && OMWT > 1) {
